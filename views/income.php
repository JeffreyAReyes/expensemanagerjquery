...
<body  >
	...
	<h2>Expense Manager - Transactions-Income</h2>	
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				...
				<input id="CatID" class="easyui-combobox"  name="CatID" data-options="
					...
					url: '../phpfiles/get_data_generic.php?WhatToLoad=INCOME',
	...
	<script type="text/javascript" src="../jsfiles/income.js"></script>
</body>
</html>